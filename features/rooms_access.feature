Feature: Join
  ...
  @wip
  Scenario: Gaining access to room
    Given I am an API client
    And I join as "Jeremy"
    When I requests POST "/api/v1/rooms/507f1f77bcf86cd799439011/authentication" with data:
    """
    {
      "password": "123"
    }
  ...
  @wip
  Scenario: Joining private room without access to room
    Given I am an API client
    And I join as "Jeremy"
    When I requests POST "/api/v1/rooms/507f1f77bcf86cd799439011/users" with data:
    """
    {
